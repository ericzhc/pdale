...
#define  DHCPc_ERR_GIVING_UP                               4
#define  DHCPc_ERR_MAC_ADDR_NOT_SET                        5
#define  DHCPc_ERR_CFG_STACK_FAILED                        6
...
#define  DHCPc_RETRY_MAX                                   5
#define  DHCPc_PKT_BUF_SIZE                              576    /* Buffer size   defined in RFC 2131, p. 10.            */

                                                                /* DHCP   ports  defined in RFC 2132, p. 23.            */
#define  DHCP_IP_PORT_SERVER                              67
#define  DHCP_IP_PORT_CLIENT                              68
...
void         DHCPc_SetParamRequestList  (CPU_INT08U   *param_request_list,
                                         CPU_INT08U    param_request_list_len);
                                                                ...
                                                                /* ---- STATUS FNCTS ---------------------------------- */
DHCP_HDR    *DHCPc_GetHdr               (void);                 /* Get DHCP ACK paquet header.                          */
...
*/
                                                                ...
                                                                /* Useful when the IP stack cannot receive unicast      */
                                                                /* packets when not fully configured.                   */
#ifndef  DHCP_CFG_BROADCAST_BIT
#error  "DHCP_CFG_BROADCAST_BIT        not #define'd in 'app_cfg.h'"
#error  "                        [MUST be  DEF_OFF]                "
#error  "                        [     ||  DEF_ON ]                "
#elif  ((DHCP_CFG_BROADCAST_BIT != DEF_OFF) && \
        (DHCP_CFG_BROADCAST_BIT != DEF_ON ))
#error  "DHCP_CFG_BROADCAST_BIT  illegally #define'd in 'app_cfg.h'"
#error  "                        [MUST be  DEF_OFF]                "
#error  "                        [     ||  DEF_ON ]                "
#endif
