...
*
*               See also 'net_tmr.h  TIMER TASK TIME DEFINES  Notes #1 & #2'
*                      & 'net_os.c  NetOS_Tmr_Task()  Notes #1 & #2'.
*********************************************************************************************************
*/

#define  NET_TMR_CFG_NBR_TMR                              91    /* Configure total number of TIMERs (see Note #1).      */
...
*
*               See also 'net_buf.h  BUFFERS  Note #3'.
*********************************************************************************************************
*/
...
*/
                                                                ...
                                                                /* ... (see Note #2) :                                  */
#define  NET_NIC_CFG_INT_CTRL_EN                DEF_DISABLED
//#define  NET_NIC_CFG_INT_CTRL_EN                DEF_ENABLED  //SipStack
...
*/
// SipStack
#define  NET_ICMP_CFG_TX_SRC_QUENCH_EN          DEF_ENABLED     /* Configure ICMP Transmit Source Quench feature :      */
...
//#define  NET_CFG_TRANSPORT_LAYER_SEL            NET_TRANSPORT_LAYER_SEL_UDP     // SipStack
...
*
*               See also 'net_udp.c  NetUDP_TxPktPrepareHdr()  Note #2b'.
*********************************************************************************************************
*/
...
*
*           (2) Stevens, TCP/IP Illustrated, Volume 1, 1st Edition, Section 20.4, Page 282 states that
...
*
*               See also 'net_tcp.h  TCP CONNECTION DEFINES  Note #1'.
*
...
*
*           (5) Configure timeout values in integer number of seconds.  Timeout values may also be
*               configured with network time constant, NET_TMR_TIME_INFINITE, to never timeout.
*********************************************************************************************************
*/
...
#define  NET_TCP_CFG_TX_WIN_SIZE_OCTET                 16384    /* Configure TCP connection transmit window size.       */


                                                                /* Configure TCP connections' default maximum ...       */
                                                                /* ... segment lifetime timeout (MSL) value,  ...       */
#define  NET_TCP_CFG_TIMEOUT_CONN_MAX_SEG_SEC              5    /* ... in integer seconds (see Note #3).                */
...
#define  NET_TCP_CFG_TIMEOUT_CONN_RX_Q_SEC                 5    /* Configure TCP connection receive  queue timeout.     */
#define  NET_TCP_CFG_TIMEOUT_CONN_TX_Q_SEC                 5    /* Configure TCP connection transmit queue timeout.     */
...
*
*           (3) Configure timeout values in integer number of seconds.  Timeout values may also be
*               configured with network time constant, NET_TMR_TIME_INFINITE, to never timeout.
*********************************************************************************************************
*/
...
#define  NET_SOCK_CFG_PORT_NBR_RANDOM_BASE             65500    /* Configure random ports' starting port number.        */


                                                                /* Configure socket timeout values (see Note #3) :      */
#define  NET_SOCK_CFG_TIMEOUT_RX_Q_SEC                     5    /* Configure socket receive    queue   timeout.         */
#define  NET_SOCK_CFG_TIMEOUT_CONN_REQ_SEC                30    /* Configure socket connection request timeout.         */
#define  NET_SOCK_CFG_TIMEOUT_CONN_ACCEPT_SEC              3    /* Configure socket connection accept  timeout.         */
#define  NET_SOCK_CFG_TIMEOUT_CONN_CLOSE_SEC              30    /* Configure socket connection close   timeout.         */
...
#define  LAN91C111_CFG_MAC_ADDR_SEL             LAN91C111_MAC_ADDR_SEL_EEPROM
                                                                /*   LAN91C111_MAC_ADDR_SEL_EEPROM   from NIC's EEPROM  */
                                                                /*   LAN91C111_MAC_ADDR_SEL_CFG      from application   */
