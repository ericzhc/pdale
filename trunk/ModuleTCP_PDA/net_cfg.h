...
#define  NET_DBG_CFG_MEM_CLR_EN                 DEF_ENABLED     /* Configure memory clear feature  (see Note #3) :      */
                                                                /*   DEF_DISABLED  Data structure clears DISABLED       */
                                                                /*   DEF_ENABLED   Data structure clears ENABLED        */

#define  NET_DBG_CFG_TEST_EN                    DEF_ENABLED     /* Configure test/debug feature(s) (see Note #4) :      */
...
#define  NET_TMR_CFG_NBR_TMR                              40    /* Configure total number of TIMERs (see Note #1).      */
