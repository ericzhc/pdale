...
*               statistics pool types.  Memory dumps of statistics pools will display the statistics pool 
...
NET_STAT_EXT  NET_CTR  NetStat_ErrInvalidTypeCtr;               /* Nbr net stats with invalid type.                     */
#endif
#endif
