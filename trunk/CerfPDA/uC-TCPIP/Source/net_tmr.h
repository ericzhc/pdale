...
*               timer types.  Memory dumps of network timers will display the timer TYPE with the chosen
*               ASCII name.
*********************************************************************************************************
*/
...
NET_TMR_EXT  NET_CTR         NetTmr_ErrNoneAvailCtr;            /* Nbr net tmrs unavail.                                */
...
NET_TMR_EXT  NET_CTR         NetTmr_ErrInvalidTypeCtr;          /* Nbr net tmrs with invalid type.                      */
#endif
#endif
