...
*
* Note(s) : (1) Configure CPU_CFG_ALIGN_TYPE  with CPU's word-alignment size :
*
*                   CPU_ALIGN_TYPE_NONE         NO     word alignment       (i.e. ONLY 8-bit)
*                   CPU_ALIGN_TYPE_16           16-bit word alignment
*                   CPU_ALIGN_TYPE_32           32-bit word alignment
*                   CPU_ALIGN_TYPE_64           64-bit word alignment       See Note #1a
*
*               (a) 64-bit word alignment NOT currently supported.
*
*           (2) Configure CPU_CFG_ENDIAN_TYPE with CPU's word-memory order :
*
...
//#define  CPU_CFG_ALIGN_TYPE                 CPU_ALIGN_TYPE_32           /* Defines CPU word-alignment size.             */
#define  CPU_CFG_ENDIAN_TYPE                CPU_ENDIAN_TYPE_LITTLE      /* Defines CPU word-memory order.               */
...
typedef  CPU_INT32U  CPU_SR;                                    /* Defines CPU status reg size (PSR = 32 bits).         */

#define     CPU_SR_Save     OS_CPU_SR_Save
#define     CPU_SR_Restore  OS_CPU_SR_Restore
...
*                                            CPU DATA TYPES
*
* Note(s) : (1) See also 'CPU WORD CONFIGURATION  Note #1'.
*********************************************************************************************************
*/

                                                                /* Defines CPU word-alignment size.                     */
/*#if     (CPU_CFG_ALIGN_TYPE == CPU_ALIGN_TYPE_16)
typedef  CPU_INT16U  CPU_ALIGN;
#elif   (CPU_CFG_ALIGN_TYPE == CPU_ALIGN_TYPE_32)
typedef  CPU_INT32U  CPU_ALIGN;
#else
typedef  CPU_INT08U  CPU_ALIGN;
#endif
...
//#ifndef   CPU_CFG_ALIGN_TYPE
//#error   "CPU_CFG_ALIGN_TYPE             not #define'd in 'cpu.h'                  "
//#error   "                         [MUST be  CPU_ALIGN_TYPE_NONE   8-bit alignment]"
//#error   "                         [     ||  CPU_ALIGN_TYPE_16    16-bit alignment]"
//#error   "                         [     ||  CPU_ALIGN_TYPE_32    32-bit alignment]"
//#elif   ((CPU_CFG_ALIGN_TYPE != CPU_ALIGN_TYPE_NONE) && \
//         (CPU_CFG_ALIGN_TYPE != CPU_ALIGN_TYPE_16  ) && \
//         (CPU_CFG_ALIGN_TYPE != CPU_ALIGN_TYPE_32  ))
//#error   "CPU_CFG_ALIGN_TYPE       illegally #define'd in 'cpu.h'                  "
//#error   "                         [MUST be  CPU_ALIGN_TYPE_NONE   8-bit alignment]"
//#error   "                         [     ||  CPU_ALIGN_TYPE_16    16-bit alignment]"
//#error   "                         [     ||  CPU_ALIGN_TYPE_32    32-bit alignment]"
//#endif
