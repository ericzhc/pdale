...
/*$PAGE*/
    ...
    pconst = (void *)&NetTCP_CfgTimeoutConnRxQ_sec;
    pconst = (void *)&NetTCP_CfgTimeoutConnTxQ_sec;
...
/*$PAGE*/
    ...
    pconst = (void *)&NetSock_CfgTimeoutRxQ_sec;

    pconst = (void *)&NetSock_CfgStreamTypeEn;
#if (NET_SOCK_CFG_TYPE_STREAM_EN == DEF_ENABLED)
    pconst = (void *)&NetSock_CfgConnAcceptQ_MaxSize;
    pconst = (void *)&NetSock_CfgTimeoutConnReq_sec;
    pconst = (void *)&NetSock_CfgTimeoutConnAccept_sec;
    pconst = (void *)&NetSock_CfgTimeoutConnClose_sec;
#endif
